 ...
 *
 * When a user is viewing the Chinese version (/zh/), we set the document's lang attribute
 * to 'zh-Hans' to signal to the browser that automatic translation might be helpful,
